...
public class Hour implements Comparable<Hour>{
     ...
     */
    public Hour(int horas, int minutos, int segundos) {
        this.horas = horas;
     ...
     */
    public boolean isMaior(Hour outroTempo) {
     ...
     *         parâmetro.
     */
    public int diferencaEmSegundos(Hour outroTempo) {
     ...
     */
    public Hour diferencaEmTempo(Hour outroTempo) {
    ...
    public Hour addMinutes (int addedMinutes){
        int hours = this.horas;
        int minutes = this.minutos + addedMinutes;
        int seconds = this.segundos;
